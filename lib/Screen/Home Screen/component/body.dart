...
import 'accessories_product_card.dart';
import 'headline_text.dart';
import 'search_field.dart';
import 'top_product_card.dart';
import 'top_product_btn.dart';
              ...
              child: SizedBox(
                ...
                child: Row(
                  ...
                  children: List.generate(
                      ...
                      (index) => TopProductCard(
                            topProductSnapshot: topProductSnapshot,
                            index: index,
                            onTap: () {
              ...
              child: SizedBox(
                ...
                child: Row(
                  ...
                  children: List.generate(
                    ...
                    (index) => AccessoriesProductCard(
                      accessoriesSnapshot: accessoriesSnapshot,
                      index: index,
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => DetailsScreen(
